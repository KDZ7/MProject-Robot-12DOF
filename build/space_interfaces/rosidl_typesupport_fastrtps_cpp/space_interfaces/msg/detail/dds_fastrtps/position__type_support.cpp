...
#include "space_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = space_interfaces::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const space_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<space_interfaces::msg::Position *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_space_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<space_interfaces::msg::Position>()
{
  return &space_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
