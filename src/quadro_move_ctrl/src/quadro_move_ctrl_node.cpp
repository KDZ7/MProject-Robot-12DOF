...
private:
    ...
    std::vector<std::vector<double>> get_seq(std::string cmd)
    {
        ...
        if (cmd == "F")
            return {
                // +2
                {0.0, 0.5, 0.3, 0.0, -0.5, 0.3, 0.0, 0.5, 0.3, 0.0, -0.5, 0.3},
                {0.0, 0.7, 0.5, 0.0, -0.7, 0.5, 0.0, 0.7, 0.5, 0.0, -0.7, 0.5},
                {0.0, 0.9, 0.7, 0.0, -0.9, 0.7, 0.0, 0.9, 0.7, 0.0, -0.9, 0.7},
        ...
        return {{0.0, 0.5, 0.3, 0.0, -0.5, 0.3, 0.0, 0.5, 0.3, 0.0, -0.5, 0.3}};
    }
